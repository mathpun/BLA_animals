...
var classification = function (spec,my) {
	...
	// messages
	my.msg_correct = '<font size="5">You got it!</font>';
	my.msg_incorrect = '<font size="5">Sorry that is wrong! The right answer is shown in </font><font size="5" color="blue">blue</font>';
